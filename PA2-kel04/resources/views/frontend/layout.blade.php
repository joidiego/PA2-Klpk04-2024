                ...
                <div class="container-fluid">
                    <div class="furniture-bottom-wrapper">
                        ...
                        <div class="furniture-wishlist">
                            <ul>
                                <li><a href="{{ url('wishlists') }}"><i class="ti-heart"></i> Favorit</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                <div class="services-wrapper">
                    ...
                    <div class="single-services mb-40">
                        ...
                        <div class="services-content">
                            <h4>metode pembayaran hemat</h4>
                            <p>Pembayaran Dapat di lakukan melalui website</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="qwick-view-right">
                            <div class="qwick-view-content">
                                ...
                                <p>Karya Penduduk lokal Bulbul Ini Memiliki Produk Souvenir dengan kualitas terbaik</p>
                                ...
                                <div class="quickview-plus-minus">
                                    ...
                                    <div class="quickview-btn-cart">
                                        <a class="btn-hover-black" href="#">Tambahkan ke Keranjang</a>
                                    </div>
